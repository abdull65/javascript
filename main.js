const popUpEl = document.getElementById("pop_up"); const containerEl = document.getElementById("container"); const bodyEl = document.querySelector("body"); const lightBgEl = 
...
function backToTop() { backToTopMsgEl.textContent = "Back to top!";
}
